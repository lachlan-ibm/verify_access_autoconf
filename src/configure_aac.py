...
def _ldap_server_connection(connection):
    props = connection.properties
...
def _jdbc_server_connection(connection):
    props = connection.properties
...
def _smtp_server_connection(connection):
    props = connection.properties
...
def upload_mapping_rules(base='.', _file=None):
    path = base + '/' + _file
...
def attributes_configuration(aac_config):
...
def api_protection_configuration(aac_config):
...
def mmfa_configuration(aac_config):
